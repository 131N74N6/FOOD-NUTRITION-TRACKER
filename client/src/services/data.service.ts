...
export default function DataService() {
    return {
        changeData: async <U>(props: IChangeData<U>) => {
            try {
        ...
        deleteData: async (props: IDeleteData) => {
            try {
                const request = await fetch(props.api_url, {
                    credentials: 'include',
                    headers: { 'Content-Type': 'application/json' },
        ...
        getData: <U>(props: IGetData): { data: U | undefined; error: Error | null; isLoading: boolean } => {
        ...
        infiniteScroll: <U>(props: InfiniteScrollIntrf) => {
        ...
        insertData: async <U>(props: IAddData<U>) => {
            try {
                const request = await fetch(props.api_url, {
                    credentials: 'include',
                    headers: { 'Content-Type': 'application/json' },
